...
#define SHA_OID_PREFIX		0x60,0x86,0x48,0x01,0x65,0x03,0x04,0x02
#define SHA224_OID			{ SHA_OID_PREFIX,0x04 }
#define SHA256_OID			{ SHA_OID_PREFIX,0x01 }
#define SHA384_OID			{ SHA_OID_PREFIX,0x02 }
#define SHA512_OID			{ SHA_OID_PREFIX,0x03 }
#define SHA512_256_OID		{ SHA_OID_PREFIX,0x06 }
#define SHA512_224_OID		{ SHA_OID_PREFIX,0x05 }
...
#define ECDSA_OID		{ 0x2A,0x86,0x48,0xCE,0x3D,0x04,0x01 }
#define ED25519_OID		{ 0x2B,0x65,0x70 }
#define SECP256R1_OID	{ 0x2A,0x86,0x48,0xCE,0x3D,0x03,0x01,0x07 }

#define OID_SHA256_WITH_RSA_ENCRYPTION {0x2A,0x86,0x48,0x86,0xF7,0x0D,0x01,0x01,0x0B}
...
#define OID_COUNTRY_NAME	{ 0x55, 0x04, 0x06 }
#define OID_ORG_NAME		{ 0x55, 0x04, 0x0A }
#define OID_ORG_UNIT_NAME	{ 0x55, 0x04, 0x0B }
#define OID_LOCALITY_NAME	{ 0x55, 0x04, 0x07 }
