...
/* -------------------------------------------------------------------
 * Groups FFDHE (RFC 7919)
 * ------------------------------------------------------------------- */

/* -------------------------------------------------------------------
 * Group ffdhe2048 (Annexe A.1.  ffdhe2048)
 * Size : 2048 bits
 * ------------------------------------------------------------------- */
static const char *FFDHE2048_P_HEX =
...
static const char *FFDHE2048_G_HEX = "2";

/* -------------------------------------------------------------------
 * Group ffdhe3072 (Annexe A.2.  ffdhe3072)
 * Size : 3072 bits
 * ------------------------------------------------------------------- */
static const char *FFDHE3072_P_HEX =
...
static const char *FFDHE3072_G_HEX = "2";

/* -------------------------------------------------------------------
 * Group ffdhe4096 (Annexe A.3.  ffdhe4096)
 * Size : 4096 bits
 * ------------------------------------------------------------------- */
static const char *FFDHE4096_P_HEX =
...
static const char *FFDHE4096_G_HEX = "2";

/* -------------------------------------------------------------------
 * Group ffdhe6144 (Annexe A.4.  ffdhe6144)
 * Size : 6144 bits
 * ------------------------------------------------------------------- */
static const char *FFDHE6144_P_HEX =
...
static const char *FFDHE6144_G_HEX = "2";

/* -------------------------------------------------------------------
 * Group ffdhe8192 (Annexe A.5.  ffdhe8192)
 * Size : 8192 bits
 * ------------------------------------------------------------------- */
static const char *FFDHE8192_P_HEX =
...
static const char *FFDHE8192_G_HEX = "2";

int	getGroupParams(int groupId, const char **pHex, const char **gHex)
{
	switch (groupId)
	{
		case FFDHE_GROUP_2048:
			*pHex = FFDHE2048_P_HEX;
			*gHex = FFDHE2048_G_HEX;
			return (1);
		case FFDHE_GROUP_3072:
			*pHex = FFDHE3072_P_HEX;
			*gHex = FFDHE3072_G_HEX;
			return (1);
		case FFDHE_GROUP_4096:
			*pHex = FFDHE4096_P_HEX;
			*gHex = FFDHE4096_G_HEX;
			return (1);
		case FFDHE_GROUP_6144:
			*pHex = FFDHE6144_P_HEX;
			*gHex = FFDHE6144_G_HEX;
			return (1);
		case FFDHE_GROUP_8192:
			*pHex = FFDHE8192_P_HEX;
			*gHex = FFDHE8192_G_HEX;
			return (1);
		default:
			return (0);
	}
