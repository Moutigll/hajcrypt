#include "../../../../includes/hash/sha/sha512_256.h"
#include "../../../../includes/hash/hmac.h" /* IWYU pragma: keep */
#include "../../../../includes/consts/sha.h"

#define SHA_NAME				sha512_256
#define SHA_CTX					t_sha512_256Ctx
#define SHA_OID					SHA512_256_OID
#define SHA_DEPRECATED			0
#define SHA_DIGEST_SIZE			SHA512_256_DIGEST_SIZE
#define SHA_BLOCK_SIZE			SHA512_256_BLOCK_SIZE
#define SHA_STATE_WORDS			8
#define SHA_WORD				uint64_t
#define SHA_H0					SHA512_256_H0
#define SHA_H1					SHA512_256_H1
#define SHA_H2					SHA512_256_H2
#define SHA_H3					SHA512_256_H3
#define SHA_H4					SHA512_256_H4
