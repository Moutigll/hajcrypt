...
#define SHA_CTX					t_sha512_224Ctx
#define SHA_OID					SHA512_224_OID
#define SHA_DEPRECATED			0
#define SHA_DIGEST_SIZE			SHA512_224_DIGEST_SIZE
#define SHA_BLOCK_SIZE			SHA512_224_BLOCK_SIZE
#define SHA_STATE_WORDS			8
#define SHA_WORD				uint64_t
#define SHA_H0					SHA512_224_H0
#define SHA_H1					SHA512_224_H1
#define SHA_H2					SHA512_224_H2
#define SHA_H3					SHA512_224_H3
#define SHA_H4					SHA512_224_H4
#define SHA_H5					SHA512_224_H5
#define SHA_H6					SHA512_224_H6
#define SHA_H7					SHA512_224_H7
#define SHA_TRANSFORM			sha512_224Transform
#define SHA_USE_ARM64			0
#define SHA_LOAD_BE(ptr)		load64Be(ptr)
#define SHA_STORE_BE(ptr, val)	store64Be(ptr, val)
#define SHA_PAD_PARAMS			{ .blockSize = SHA512_224_BLOCK_SIZE, .isLittleEndian = 0, .lengthFieldSize = 8 }
